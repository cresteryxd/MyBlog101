...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">Management</a> &raquo; Links_Management
    </div>
    <!--面包屑导航 结束-->
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/links/'.$v->link_id.'/edit')}}">EDIT</a>
                            <a href="javascript:;" onclick="delCate({{$v->link_id}})">DELETE</a>
                        </td>
                    </tr>
