...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">Management</a> &raquo; <a href="{{url('admin/info')}}"> Category_Management</a> &raquo; Add Category
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/category')}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                <tr>
                    <th width="120"><i class="require">*</i>Parent_ID：</th>
                    <td>
                        <select name="cate_pid">
                            <option value="0">==Top_Categories==</option>
                            @foreach($data as $d)
                ...
                <tr>
                    <th><i class="require">*</i>Category_Name：</th>
                    <td>
